...
ggplot2::ggplot(dat, aes(x = Yr)) +
  ...
  ylim(30, 80) +
  scale_color_manual(
    values = c("X4" = "blue", "X8" = "green", "X30" = "red", "X40" = "purple"),
    labels = c("X4" = "4", "X8" = "8", "X30" = "30", "X40" = "plus group"),
    breaks = c("X4", "X8", "X30", "X40")  # Controls order in legend
  ) +
  scale_shape_manual(values = c(3, 1),
                     labels = c("3.30.24.1" = "old", "test" = "new")) +
  annotate("rect", 
           xmin = 1998.5, xmax = 2000.5,   # X-axis boundaries
           ymin = 71, ymax = 76,   # Y-axis boundaries
           fill = NA,             # Fill color
           color = "red",        # Border color
           linewidth = 1) +
  annotate("rect", 
            xmin = 1986.5, xmax = 1987.5,   # X-axis boundaries
            ymin = 52, ymax = 56,   # Y-axis boundaries 
            fill = NA,             # Fill color
            color = "red",        # Border color
            linewidth = 1) +
  annotate("rect", 
            xmin = 1983.5, xmax = 1984.5,   # X-axis boundaries
            ymin = 40, ymax = 44,   # Y-axis boundaries
            fill = NA,             # Fill color
            color = "red",        # Border color
            linewidth = 1) +
...
#| warning: false
#| message: false
#| fig-cap: "Mean length-at-age for the one season model with growth option G1 (von Bertallanffy) in subseason 2 using the old (+) and the new SS3 (O) executables at ages 4, 8, 30 and plus group (40)"
...
ggplot2::ggplot(dat, aes(x = Yr)) +
  ...
  scale_shape_manual(values = c(3, 1),
                     labels = c("3.30.24.1" = "old", "test" = "new")) +
  labs(title = "Mean length-at-age for the one season model with growth option G1\n(von Bertallanffy) in subseason 2",
       x = "Year",
       y = "Mean length-at-age",
       shape = "Model",
       color = "Age") +
