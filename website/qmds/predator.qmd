...
```{r, echo = FALSE, out.width = "450px", fig.cap="Figure 1. {r4ss} data plot with predator data.", fig.alt="{r4ss} data plot with predator data present in abundance indices, length compositions, and discards."}
