...
-   Phases are a way of switching on and off the estimation of
    parameters. A negative phase means that you are fixing a parameter
    and it is not estimated, a positive phase means that you want the
    model to estimate the parameter.
