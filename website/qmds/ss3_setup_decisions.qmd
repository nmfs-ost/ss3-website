...
flowchart TB
    ...
    B -- Yes --> C("Population age bins can go 
                  higher than data age bins")
    D["Is unfished equilibrium estimated to 
      have older fish than has been observed?"] -- Yes --> C
    B -- No --> E("Population age bins can't go 
                  higher than data age bins")
    D -- No --> E
    linkStyle 1,2,3,4 stroke-width:2px,color:black
    style C fill:steelblue
