#V3.30.xx.yy;_safe;_compile_date:_May  1 2024;_Stock_Synthesis_by_Richard_Methot_(NOAA)_using_ADMB_13.1
...
# Sex: 1  BioPattern: 1  Growth
 -10 45 21.672 36 10 6 2 0 0 0 0 0 0 0 # L_at_Amin_Fem_GP_1
 40 90 71.6667 70 10 6 4 0 0 0 0 0 0 0 # L_at_Amax_Fem_GP_1
 0.05 0.25 0.147074 0.15 0.8 6 4 0 0 0 0 0 0 0 # VonBert_K_Fem_GP_1
...
# Sex: 2  BioPattern: 1  Growth
 ...
 40 90 69.5487 70 10 6 4 0 0 0 0 0 0 0 # L_at_Amax_Mal_GP_1
 0.05 0.25 0.163321 0.15 0.8 6 4 0 0 0 0 0 0 0 # VonBert_K_Mal_GP_1
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn #  parm_name
             3            31       8.81745          10.3            10             0          1          0          0          0          0          0          0          0 # SR_LN(R0)
           0.2             1      0.573383           0.7          0.05             1          4          0          0          0          0          0          0          0 # SR_BH_steep
...
1 # (0/1) to read 13 advanced options
 ...
 -3 #_max_bias_adj_in_MPD (typical ~0.8; -3 sets all years to 0.0; -2 sets all non-forecast yrs w/ estimated recdevs to 1.0; -1 sets biasadj=1.0 for all yrs w/ recdevs)
...
# (A) (B) (C)
 1 0.094107 -1 # FISHERY
-9999 1 1 # end of list
#F_detail template: Fleet Yr Seas F_value catch_se phase
3 #_number of loops for hybrid tuning; 4 precise; 3 faster; 2 enough if switching to parms is enabled
#
#_initial_F_parms; for each fleet x season that has init_catch; nest season in fleet; count = 1
#_for unconstrained init_F, use an arbitrary initial catch and set lambda=0 for its logL
#_ LO HI INIT PRIOR PR_SD  PR_type  PHASE
 0 1 0.094107 10.3 10 0 1 # InitF_seas_1_flt_1FISHERY
#
...
# FISHERY 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107 0.094107
#
#_Q_setup for fleets with cpue or survey data
#_1:  fleet number
#_2:  link type: 1=simple q; 2=mirror; 3=power (+1 parm); 4=mirror with offset (+1p); 5=offset (+1p); 6=offset & power (+2p)
...
#_Q_parameters
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
            -7             5       0.51806             0             1             0          1          0          0          0          0          0          0          0  #  LnQ_base_SURVEY1(2)
             0           0.5             0          0.05             1             0         -4          0          0          0          0          0          0          0  #  Q_extraSD_SURVEY1(2)
            -7             5      -6.62588             0             1             0          1          0          0          0          0          0          0          0  #  LnQ_base_SURVEY2(3)
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
# 1   FISHERY LenSelex
            19            80       53.7251            50          0.01             1          2          0          0          0          0          0          0          0  #  Size_inflection_FISHERY(1)
          0.01            60       18.9714            15          0.01             1          3          0          0          0          0          0          0          0  #  Size_95%width_FISHERY(1)
# 2   SURVEY1 LenSelex
            19            70       36.6694            30          0.01             1          2          0          0          0          0          0          0          0  #  Size_inflection_SURVEY1(2)
          0.01            60       6.61599            10          0.01             1          3          0          0          0          0          0          0          0  #  Size_95%width_SURVEY1(2)
# 3   SURVEY2 LenSelex
# 1   FISHERY AgeSelex
