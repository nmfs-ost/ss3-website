...
![](qmds/images/stock_assess_continuation_tool.PNG){width="90%" fig-alt="Stock Synthesis Around the World. Picture of a world map with comment boxes of one or more examples of stocks that use Stock Synthesis placed near the area of that stock assessment region."}
