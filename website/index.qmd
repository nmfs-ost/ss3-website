...
![](qmds/images/icon-download.png){fig-align="left" height="05%" width="05%" fig-alt="download icon"} 
...
![](qmds/images/stock_assess_cont_tool.PNG){width="90%" fig-alt="Stock Synthesis Around the World. Picture of a world map with comment boxes of one or more examples of stocks that use Stock Synthesis placed near the area of that stock assessment region."}
=======
...
![](qmds/images/stock_assess_cont_tool.PNG){width="90%" fig-alt="Screen shot of the Stock Assessment Continuum Tool Shiny app"}
>>>>>>> Stashed changes
...
![](qmds/images/r4ss_logo.png){style="float: right;" fig-align="right" width="120" height="140" fig-alt="r4ss package hex logo"}
...
- [SSI](https://vlab.noaa.gov/web/stock-synthesis/document-library/-/document_library/0LmuycloZeIt/view/5042951): Stock Synthesis Interface, a GUI for developing models and running Stock Synthesis which links to {r4ss}. Not supported for versions of Stock Synthesis beyond v.3.30.21.
