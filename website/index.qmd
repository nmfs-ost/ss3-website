...
To learn more about how to build your own models in Stock Synthesis with the input files, see the [Develop a Stock Synthesis model guide](https://nmfs-stock-synthesis.github.io/doc/ss3_model_tips.html).
