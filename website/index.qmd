...
To learn more about how to build your own models in Stock Synthesis using the input files directly, see the [Develop a Stock Synthesis model guide](https://nmfs-ost.github.io/ss3-doc/ss3_model_tips.html).

### Viewing Stock Synthesis Output with {r4ss}
![](https://github.com/r4ss/r4ss/blob/main/man/figures/logo.svg){style="float: right;" fig-alt="Hex logo that says \"r4ss\"" fig-align="right" width="250"}
